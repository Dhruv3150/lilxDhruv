    ...
    <Stack direction={['column', 'row']} h={'100vh'}>
      <VStack w={'full'}>
        ...
        <VStack alignItems={'flex-start'} p={'8'} w={'full'} overflowY={'auto'}>
          ...
          <Text>
            This Is a Sample Video For Tasting And Demo. This Is Called
            DescriptionThis Is a Sample Video For Tasting And Demo. This Is
            Called DescriptionThis Is a Sample Video For Tasting And Demo. This
            Is Called DescriptionThiThis Is a Sample Video For Tasting And Demo.
            This Is Called DescriptionThis Is
          </Text>
        </VStack>
      </VStack>
